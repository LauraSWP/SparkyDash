...
$.ajax({
    url: 'https://pokemondb.net/pokedex/'+ newValue.toLowerCase(),
    type: 'GET',
...
var art = document.querySelector('input[name="pokemon"]');
art.addEventListener('change', function() {
const pokeart = document.getElementById('pokeart');
pokeart.classList.toggle("hide");
pokeart.classList.toggle("show");
});
const statshow = document.getElementById('statshow');
const stats = document.getElementById('find');
